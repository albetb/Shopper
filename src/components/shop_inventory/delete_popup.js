        ...
        <div className='popup' style={popupStyle} ref={popupRef}>
            <div className='card-side-div width-90'>
                <input
                    ...
                    min='0'
                    max={itemNumber}
                    className='small-scrollbar no-padding'
                />
            ...
            <div className='card-side-div margin-top width-90'>
                <button className='item-number-button medium' onClick={handleDelete}>
                    <span className='material-symbols-outlined'>
                        remove_shopping_cart
                    </span>
                </button>

                <button className='item-number-button medium' onClick={onClose}>
                    <span className='material-symbols-outlined'>
                        close
                    </span>
                </button>
